...
const file_transport_internet_headers_noop_config_proto_rawDesc = "" +
	...
	"\x06Config\"\x12\n" +
	"\x10ConnectionConfigB\x9d\x01\n" +
	"(com.xray.transport.internet.headers.noopP\x01ZHgithub.com/amnezia-vpn/amnezia-xray-core/transport/internet/headers/noop\xaa\x02$Xray.Transport.Internet.Headers.Noopb\x06proto3"
