...
const file_transport_internet_headers_http_config_proto_rawDesc = "" +
	...
	"\bresponse\x18\x02 \x01(\v24.xray.transport.internet.headers.http.ResponseConfigR\bresponseB\x9d\x01\n" +
	"(com.xray.transport.internet.headers.httpP\x01ZHgithub.com/amnezia-vpn/amnezia-xray-core/transport/internet/headers/http\xaa\x02$Xray.Transport.Internet.Headers.Httpb\x06proto3"
