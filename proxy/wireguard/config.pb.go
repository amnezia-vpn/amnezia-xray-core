...
func (x *AmneziaParamters) GetJc() string {
	if x != nil {
		return x.Jc
	}
	return ""
...
func (x *AmneziaParamters) GetJmin() string {
	if x != nil {
		return x.Jmin
	}
	return ""
...
func (x *AmneziaParamters) GetJmax() string {
	if x != nil {
		return x.Jmax
	}
	return ""
...
func (x *AmneziaParamters) GetS1() string {
	if x != nil {
		return x.S1
	}
	return ""
...
func (x *AmneziaParamters) GetS2() string {
	if x != nil {
		return x.S2
	}
	return ""
...
func (x *AmneziaParamters) GetS3() string {
	if x != nil {
		return x.S3
	}
	return ""
...
func (x *AmneziaParamters) GetS4() string {
	if x != nil {
		return x.S4
	}
	return ""
...
type DeviceConfig struct {
	...
	Parameters     *AmneziaParamters           `protobuf:"bytes,10,opt,name=parameters,proto3,oneof" json:"parameters,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *DeviceConfig) GetParameters() *AmneziaParamters {
	if x != nil {
		return x.Parameters
	}
	return nil
...
const file_config_proto_rawDesc = "" +
	"\n" +
	"\fconfig.proto\x12\x14xray.proxy.wireguard\"\xad\x01\n" +
	"\n" +
	"PeerConfig\x12\x1d\n" +
	"\n" +
	...
	"\x02i5\x18\x10 \x01(\tR\x02i5\"\xa7\x04\n" +
	...
	"\rno_kernel_tun\x18\t \x01(\bR\vnoKernelTun\x12K\n" +
	"\n" +
	"parameters\x18\n" +
	" \x01(\v2&.xray.proxy.wireguard.AmneziaParamtersH\x00R\n" +
	"parameters\x88\x01\x01\"\\\n" +
	...
	"FORCE_IP64\x10\x04B\r\n" +
	"\v_parametersBm\n" +
	"\x18com.xray.proxy.wireguardP\x01Z8github.com/amnezia-vpn/amnezia-xray-core/proxy/wireguard\xaa\x02\x14Xray.Proxy.WireGuardb\x06proto3"
...
var file_config_proto_depIdxs = []int32{
	...
	2, // 2: xray.proxy.wireguard.DeviceConfig.parameters:type_name -> xray.proxy.wireguard.AmneziaParamters
