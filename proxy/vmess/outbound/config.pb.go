...
const file_proxy_vmess_outbound_config_proto_rawDesc = "" +
	...
	"\x06Config\x12@\n" +
	"\bReceiver\x18\x01 \x01(\v2$.xray.common.protocol.ServerEndpointR\bReceiverB|\n" +
	"\x1dcom.xray.proxy.vmess.outboundP\x01Z=github.com/amnezia-vpn/amnezia-xray-core/proxy/vmess/outbound\xaa\x02\x19Xray.Proxy.Vmess.Outboundb\x06proto3"
