...
const file_app_router_command_command_proto_rawDesc = "" +
	...
	"\bListRule\x12(.xray.app.router.command.ListRuleRequest\x1a).xray.app.router.command.ListRuleResponse\"\x00Bv\n" +
	"\x1bcom.xray.app.router.commandP\x01Z;github.com/amnezia-vpn/amnezia-xray-core/app/router/command\xaa\x02\x17Xray.App.Router.Commandb\x06proto3"
