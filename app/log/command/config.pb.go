...
const file_app_log_command_config_proto_rawDesc = "" +
	...
	"\rLoggerService\x12j\n" +
	"\rRestartLogger\x12*.xray.app.log.command.RestartLoggerRequest\x1a+.xray.app.log.command.RestartLoggerResponse\"\x00Bm\n" +
	"\x18com.xray.app.log.commandP\x01Z8github.com/amnezia-vpn/amnezia-xray-core/app/log/command\xaa\x02\x14Xray.App.Log.Commandb\x06proto3"
